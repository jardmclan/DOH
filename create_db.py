...
print(f"Loaded {len(df_diag_su):,} diag_su records, {len(df_diag_mh):,} diag_mh records, and {len(df_demo):,} demographics records")
...
for table in ['discharge_data_view_diag_su', 'discharge_data_view_diag_mh', 'discharge_data_view_demographics']:
